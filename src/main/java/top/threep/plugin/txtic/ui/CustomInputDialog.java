...
public class CustomInputDialog extends Messages.InputDialog {
    public CustomInputDialog(Project project, @NlsContexts.DialogMessage String message, @NlsContexts.DialogTitle String title, @Nullable Icon icon, @Nullable @NonNls String initialValue, @Nullable InputValidator validator, String @NlsContexts.Button [] options, int defaultOption, @Nullable @NlsContexts.DetailedDescription String comment) {
